    ...
    _Always_(_Outptr_opt_result_maybenull_) ID3DBlob** ppErrorBlob) noexcept
{
    ...
    switch (MaxVersion)
    {
        case D3D_ROOT_SIGNATURE_VERSION_1_0:
            ...
            {
                case D3D_ROOT_SIGNATURE_VERSION_1_0:
                    return D3D12SerializeRootSignaturePtr(&pRootSignatureDesc->Desc_1_0, D3D_ROOT_SIGNATURE_VERSION_1, ppBlob, ppErrorBlob);
                ...
                case D3D_ROOT_SIGNATURE_VERSION_1_1:
                {
                    ...
                    if (SUCCEEDED(hr))
                    {
                        ...
                        hr = D3D12SerializeRootSignaturePtr(&desc_1_0, D3D_ROOT_SIGNATURE_VERSION_1, ppBlob, ppErrorBlob);
                    }
        ...
        case D3D_ROOT_SIGNATURE_VERSION_1_1:
            return D3D12SerializeVersionedRootSignaturePtr(pRootSignatureDesc, ppBlob, ppErrorBlob);
    }
